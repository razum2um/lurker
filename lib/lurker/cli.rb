  ...
  class Cli < Thor
    ...
    def init_docs(lurker_path=Lurker::DEFAULT_SERVICE_PATH)
      ...
      services.each do |srv|
        schemas = [srv.schema] + srv.endpoints.map(&:schema)
        schemas.each do |schema|
          create_file schema.documentation_uri, skip: true do
            rel_path = Pathname.new(schema.documentation_uri).relative_path_from(Pathname.getwd)
            "This is an autogenerated documentation stub. You can edit it in: `#{rel_path}`"
          end
        end
      end
    end
